...
plt.plot(df_uproot["size"], df_uproot["maxresident"], label="uproot-tensorflow", linewidth=line_width)
...
plt.hist(df_uproot[(df_uproot["time"] < 0.01) & (df_uproot["time"] > 0)]["time"]*1000, bins=100, label="TensorFlow", alpha=.75)
plt.hist(df_ROOT[(df_ROOT["time"] < 0.01) & (df_ROOT["time"] > 0)]["time"]*1000, bins=100, label="RBatchGenerator", alpha=.75)
