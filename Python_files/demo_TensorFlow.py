...
from batch_generator import GetGenerators, CreateTFDatasets
...
ds_train, ds_valid = CreateTFDatasets(
    file_name, tree_name, chunk_rows, batch_rows, validation_split=0.3, target="Type"
)
...
model.fit(
    ...
    epochs=1,
    callbacks=[BatchTimer("Tensorflow_ROOT")],
)
